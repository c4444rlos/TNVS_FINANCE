...
<html>
 <head>
  ...
  <body class="bg-white">
    ...
    <a class="bg-blue-700 text-white px-2 py-1 mx-1 rounded text-lg cursor-pointer whitespace-nowrap mb-4 float-right shadow-lg" href="ledger_revenue.php" role="button">Revenue</a>
    <a class="bg-white border-2 border-blue-800 text-blue-800 font-bold  px-2 py-1 mx-1 rounded text-lg cursor-pointer whitespace-nowrap mb-4 float-right shadow-lg" href="ledger_expense.php" role="button">Expense</a>
    ...
    <h1 class="font-bold text-2xl text-blue-900 mb-8">LEDGER (EXPENSE)</h1>
    ...
    <script>
        const trialBalanceData = [
                    ...
                    { date: "2024-11-19", account: "Equipment/Assets", debit: "₱5,000.00", credit: "", balance: "₱5,000.00" },
                    { date: "2024-11-19", account: "Salaries Expense", debit: "₱2,000.00", credit: "", balance: "₱2,000.00" },
                    { date: "2024-11-19", account: "Bonuses Expense", debit: "₱1,000.00", credit: "", balance: "₱1,000.00" },
                    { date: "2024-11-19", account: "Facility Cost", debit: "₱1,500.00", credit: "", balance: "₱1,500.00" },
                    { date: "2024-11-20", account: "Maintenance/Repair", debit: "₱500.00", credit: "", balance: "₱500.00" },
                    { date: "2024-11-20", account: "Training Cost", debit: "₱1,200.00", credit: "", balance: "₱1,200.00" },
                    { date: "2024-11-21", account: "Wellness Program Cost", debit: "₱2,000.00", credit: "", balance: "₱2,000.00" },
                    { date: "2024-11-21", account: "Tax Payment", debit: "₱1,000.00", credit: "", balance: "₱1,000.00" },
                    { date: "2024-11-21", account: "Miscellaneous Expense", debit: "₱700.00", credit: "", balance: "₱700.00" },
                    { date: "2024-11-22", account: "Salaries Expense", debit: "₱1,000.00", credit: "", balance: "₱3,000.00" }
