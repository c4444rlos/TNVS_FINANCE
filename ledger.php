...
<html>
 <head>
  ...
  <body class="bg-white">
    ...
    <a class="bg-white border-2 border-blue-800 text-blue-800 font-bold px-2 py-1 mx-1 rounded text-lg cursor-pointer whitespace-nowrap mb-4 float-right shadow-lg" href="ledger.php" role="button">Asset</a>
</div>
    <h1 class="font-bold text-2xl text-blue-900 mb-8">LEDGER (ASSET)</h1>
    ...
    <script>
        const trialBalanceData = [
            { date: "2024-11-19", account: "Cash", debit: "₱1,000.00", credit: "", balance: "₱1,000.00" },
            { date: "2024-11-19", account: "eCash", debit: "₱2,000.00", credit: "", balance: "₱2,000.00" },
            { date: "2024-11-20", account: "Money in Bank", debit: "₱5,000.00", credit: "", balance: "₱5,000.00" },
            { date: "2024-11-20", account: "Cheques", debit: "₱500.00", credit: "", balance: "₱500.00" },
            { date: "2024-11-20", account: "Accounts Receivable", debit: "₱3,000.00", credit: "", balance: "₱3,000.00" },
            { date: "2024-11-21", account: "Cash", debit: "", credit: "₱500.00", balance: "₱500.00" },
            { date: "2024-11-21", account: "Money in Bank", debit: "", credit: "₱1,000.00", balance: "₱4,000.00" },
            { date: "2024-11-21", account: "Accounts Receivable", debit: "", credit: "₱2,000.00", balance: "₱1,000.00" },
            { date: "2024-11-22", account: "eCash", debit: "", credit: "₱1,000.00", balance: "₱1,000.00" },
            { date: "2024-11-22", account: "Cash", debit: "₱1,500.00", credit: "", balance: "₱2,000.00" }
        ];
