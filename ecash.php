 ...
 <head>
  ...
  <body class="bg-white">
    ...
    <div class="bg-blue-200 p-4 shadow-lg">
     <nav class="text-gray-600 font-bold">
      <ol class="list-reset flex">
       ...
       <li>
        <a class="text-gray-600 font-bold" href="#">Ecash Payout</a>
       </li>
      </ol>
     </nav>
    </div>
    ...
    <div class="flex-1 bg-blue-100 p-6 h-full w-full">
     ...
     <h1 class="font-bold text-2xl text-blue-900 mb-8">E-CASH PAYOUT</h1> 
        ...
        <table class="min-w-full bg-white border-8 border-blue-200 shadow-2xl">
            <thead>
                <tr class="bg-blue-200 text-blue-800 uppercase text-sm leading-normal">
                    ...
                    <th class="px-4 py-2">Ecash Name</th>
                    <th class="px-4 py-2">Ecash Number</th>
                    <th>Payment Due</th>
                    <th>Actions</th>
                </tr>
            </thead>
...
if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) {
        ...
        echo "<td class='pt-3 px-6 text-left border-r border-gray-300'>
                <form method='POST' action=''>
                    <input type='hidden' name='approve_id' value='{$row['id']}'>
                    <button type='submit' class='bg-green-500 text-white px-2 py-1 rounded'>Disburse</button>
                </form>
