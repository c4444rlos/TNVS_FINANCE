...
<html>
 <head>
  ...
  <body class="bg-white">
    ...
    <a class="bg-white border-2 border-blue-800 text-blue-800 font-bold px-2 py-1 mx-1 rounded text-lg cursor-pointer whitespace-nowrap mb-4 float-right shadow-lg" href="ledger_liabilities.php" role="button">Liabilities</a>
    ...
    <h1 class="font-bold text-2xl text-blue-900 mb-8">LEDGER (LIABILITIES)</h1>
    ...
    <script>
        const trialBalanceData = [    
                { date: "2024-11-19", account: "Accounts Payable", debit: "", credit: "₱500.00", balance: "₱500.00" },
                { date: "2024-11-19", account: "Tax Payable", debit: "", credit: "₱1,000.00", balance: "₱1,000.00" },
                { date: "2024-11-20", account: "Accounts Payable", debit: "", credit: "₱700.00", balance: "₱1,200.00" },
                { date: "2024-11-20", account: "Tax Payable", debit: "", credit: "₱500.00", balance: "₱1,500.00" },
                { date: "2024-11-21", account: "Accounts Payable", debit: "", credit: "₱200.00", balance: "₱1,400.00" },
                { date: "2024-11-21", account: "Tax Payable", debit: "", credit: "₱800.00", balance: "₱2,300.00" },
                { date: "2024-11-21", account: "Accounts Payable", debit: "₱300.00", credit: "", balance: "₱1,100.00" },
                { date: "2024-11-21", account: "Tax Payable", debit: "₱600.00", credit: "", balance: "₱1,700.00" },
                { date: "2024-11-22", account: "Accounts Payable", debit: "", credit: "₱100.00", balance: "₱1,000.00" },
